 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "Gen_Purchase_Count=[]\n",
    "Gen_AvgPurchase_Price=[]\n",
    "Gen_Total_Purchase_Value=[]\n",
    "Gen_AvgTotalPurchase_per_Person=[]\n",
    "for gender in Genders:\n",
    "    Gender_PurAnalysis =purchase_data.loc[(purchase_data['Gender']==gender),:]\n",
    "    Gen_Purchase_Count.append(len(Gender_PurAnalysis['Item ID']))\n",
    "    Gen_AvgPurchase_Price.append(Gender_PurAnalysis['Price'].sum()/len(Gender_PurAnalysis['Item ID']))\n",
    "    Gen_Total_Purchase_Value.append(Gender_PurAnalysis['Price'].sum())\n",
    "    Gen_AvgTotalPurchase_per_Person.append(Gender_PurAnalysis['Price'].sum()/len(Gender_PurAnalysis['SN'].unique()))\n",
    "Gen_Purchasing_Analysis = pd.DataFrame({\"Purchase Count\":Gen_Purchase_Count,\\\n",
    "                                   \"Average Purchase Price\":Gen_AvgPurchase_Price,\\\n",
    "                                   \"Total Purchase Value\":Gen_Total_Purchase_Value,\\\n",
    "                                   \"Avg Total Purchase per Person\":Gen_AvgTotalPurchase_per_Person},index =[\"Female\",\"Male\",\"Other / Non-Disclosed\"])\n",
    "\n",
    "Gen_Purchasing_Analysis[\"Average Purchase Price\"]=Gen_Purchasing_Analysis[\"Average Purchase Price\"].map(\"${:.2f}\".format)\n",
    "Gen_Purchasing_Analysis[\"Total Purchase Value\"]=Gen_Purchasing_Analysis[\"Total Purchase Value\"].map(\"${:,.2f}\".format)\n",
    "Gen_Purchasing_Analysis[\"Avg Total Purchase per Person\"]=Gen_Purchasing_Analysis[\"Avg Total Purchase per Person\"].map(\"${:.2f}\".format)\n",
    "Gen_Purchasing_Analysis.index.name= 'Gender'\n",
    "Gen_Purchasing_Analysis"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    "Age_Purchase_Count=[]\n",
    "Age_AvgPurchase_Price=[]\n",
    "Age_Total_Purchase_Value=[]\n",
    "Age_AvgTotalPurchase_per_Person=[]\n",
    "labels = [\"10-14\", \"15-19\",\"20-24\",\"25-29\",\"30-34\",\"35-39\",\"40+\",\"<10\"]\n",
    "for label in labels:\n",
    "    Age_Demographicsdf = purchase_data.loc[purchase_data[\"Purchase Count\"] == label,:]\n",
    "    Age_Purchase_Count.append(len(Age_Demographicsdf['Item ID']))\n",
    "    Age_AvgPurchase_Price.append(Age_Demographicsdf['Price'].sum()/len(Age_Demographicsdf['Item ID']))\n",
    "    Age_Total_Purchase_Value.append(Age_Demographicsdf['Price'].sum())\n",
    "    Age_AvgTotalPurchase_per_Person.append(Age_Demographicsdf['Price'].sum()/len(Age_Demographicsdf['SN'].unique()))\n",
    ...
    "                                   \"Avg Total Purchase per Person\":Age_AvgTotalPurchase_per_Person},index =[\"10-14\", \"15-19\",\"20-24\",\"25-29\",\"30-34\",\"35-39\",\"40+\",\"<10\"])\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "Items_SortDf = Items_Df.groupby(by =[\"Item ID\",\"Item Name\"])\n",
    "Popular_Itemsdf = pd.DataFrame({\"Purchase Count\":Items_SortDf[\"Price\"].count(), \"Item Price\":Items_SortDf[\"Price\"].mean(),\"Total Purchase Value\":Items_SortDf[\"Price\"].sum()})\n",
    "Popular_Items = Popular_Itemsdf.sort_values(\"Purchase Count\", ascending=False)\n",
    "Popular_Items[\"Item Price\"] = Popular_Items[\"Item Price\"].map(\"${:.2f}\".format)\n",
    "Popular_Items[\"Total Purchase Value\"] = Popular_Items[\"Total Purchase Value\"].map(\"${:,.2f}\".format)\n",
    "#Popular_Itemsdf.sort_values(by=['Purchase Count'], ascending=False)\n",
    "Popular_Items.head()\n"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "Most_Popular_Items = Popular_Itemsdf.sort_values('Total Purchase Value', ascending =False)\n",
